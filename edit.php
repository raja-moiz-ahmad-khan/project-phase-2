...
if(isset($_POST['update']))
{
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE products SET name='$name', qty='$qty', price='$price', instock='$stock', code='$code',
    discount='$discount', size='$size', details='$details', image='$img' WHERE id='$id'");
...
<h1 style="color:#FFD700; 	 margin:20px;">Modify Products</h1><br><br>
	    ...
	    <div class="container" style="margin-top: 20px">
			...
			<div class="col-sm-6">
                ...
                <form name="form1" method="post" action="edit.php" enctype="multipart/form-data">
                    ...
                    <input class="form-control"  type="text" name="qty" value="<?php echo $qty;?>" required>
                     <br>
                    ...
                    Yes <input class="radio-inline" type="radio" style="background-color: black" name="stock" value="yes" required>

                    No <input class="radio-inline" type="radio"  name="stock" value="no">

                    <br>

                    <label> Discount: </label>
                    <input class="form-control"  type="text" name="discount" value="<?php echo $discount;?>" required>
                     <br>

                    <label> Size: </label>
                    <input class="form-control"  type="text" name="size" value="<?php echo $size;?>" required>
                     <br>

                    Details: <br>
                    <textarea class="form-control" name="details"  col="20" rows="5" required><?php echo $details;?></textarea>
                    <br>
                    <input type="file" name="file" placeholder="jpg" required><br><br>
