...
<h1 style="color:#FFD700; 	 margin:20px;">Register</h1><br><br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])) {
                    ...
                    $pass = $_POST['password'];
                        ...
                        echo "<button class='btn btn-warning' onclick=document.location='login.php'>Log In</button>";

                } else {
                    echo "<form name='form1' method='post' action=''>
                    <label> Full Name: </label>
                    <input class='form-control'  type='text' name='name' id='name' placeholder='Your Name...' required> <br>
                    <label> Email: </label>
                    <input class='form-control'  type='text' name='email' id='email' placeholder='sample@gmail.com...' required> <br>
                    <label> Userame: </label>
                    <input class='form-control'  type='text' name='username' id='username' placeholder='Your Userame...' required> <br>
                ...
                </form><br>Already have an account? <a style='color: seagreen' href='login.php'>Log in now!</a>";
                } ?>
            </div>
            <div class="col-md-6">
